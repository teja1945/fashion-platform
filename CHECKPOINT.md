...
PENTING — masalah CDN caching raw.githubusercontent.com: link raw GitHub sering nge-cache versi lama beberapa menit setelah push, jadi room baru bisa dapet checkpoint yang BELUM update meski sudah di-push. Solusi: (1) tunggu 2-5 menit setelah push sebelum buka room baru, ATAU (2) tambahkan query string cache-bust di link, contoh https://raw.githubusercontent.com/teja1945/fashion-platform/refs/heads/main/CHECKPOINT.md?t=TIMESTAMP (ganti TIMESTAMP dengan angka/waktu random tiap kali), ATAU (3) selalu sebutkan commit hash terbaru (dari output git push) ke Claude di awal sesi, dan minta Claude konfirmasi isi checkpoint yang di-fetch sudah sesuai/terbaru sebelum lanjut kerja.
